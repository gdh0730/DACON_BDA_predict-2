...
"""
고도화 EDA 스크립트 (v2)
- 입력: open/train.csv (기본)
- 출력: eda_output_v2/YYYYMMDD_HHMMSS/{reports,figures,artifacts}
- 목적: v1 결과를 확장해 멀티선택/텍스트 신호, 연관강도, 중복/누수 의심을 강화 진단
"""
...
# 메인 EDA
# =========================
def run_eda(train_path: str, target: str = "completed", id_col: str = "ID", outdir: str = "eda_output_v2"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--outdir", type=str, default="eda_output_v2")
